...
public class ALTextInputBar: UIView, ALTextViewDelegate {
    ...
    */
    ...
    public let textView: ALTextView = {
        ...
        _textView.textContainerInset = UIEdgeInsetsMake(7, 2, 7, 0);
        ...
        var tempBorderColor = UIColor(red: 191/255.0, green: 191/255.0, blue: 191/255.0, alpha:1 )
        _textView.layer.borderColor = tempBorderColor.CGColor
